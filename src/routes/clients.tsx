...
const CLIENTS: Client[] = [
  {
    ...
    description: "A Filipino fashion brand built around affordable, trendy pieces. I managed their full Instagram presence â€” brand voice, content calendar, templates, and community management. Also secured a B2B collab.",
  ...
  },
  {
    ...
    name: "PSG Hits",
    handle: "@psghits",
    platform: "Facebook Â· Instagram",
    category: "Music & Entertainment",
    description: "A local music and entertainment brand. I managed their social media presence â€” content creation, graphic design, and community engagement to grow their audience.",
  ...
  },
  {
    ...
    description: "A local plumbing and drainage service. I built and managed their social media presence to generate leads and build trust with local customers.",
  ...
  },
  {
    ...
    platform: "Facebook",
    category: "Government Â· Tourism",
    description: "The official tourism office of Masinloc, Zambales. I managed their Facebook page â€” creating content that showcased local destinations, events, and culture to drive tourism.",
  ...
  },
  {
    ...
    description: "A local restaurant. I handled their Facebook social media â€” food photography direction, promotional posts, and community engagement to drive foot traffic.",
    services: ["Social Media Management", "Graphic Design"],
  ...
  },
  {
    ...
    platform: "Instagram Â· Facebook",
    category: "Travel & Lifestyle",
    description: "A travel and lifestyle brand â€” currently in pre-launch strategy and content planning phase.",
        ...
        {src
          ...
          : (
            <div className="text-center p-4">
              <p className="text-white/10 text-[24px]">âœ¦</p>
...
/* â”€â”€â”€ Client modal â€” full-page sheet from bottom â”€â”€â”€ */
    ...
    >
      ...
      >
        ...
        <div className="flex h-10 items-center justify-between border-b border-border bg-secondary/60 px-5 sticky top-0 z-10" style={{ borderRadius: "20px 20px 0 0" }}>
          ...
          <button onClick={onClose} className="text-[11px] tracking-tight text-foreground/35 hover:text-foreground transition">âœ• close</button>
        </div>
            ...
            <div className="relative z-10 px-10 pb-8 w-full">
              <div className="flex items-end justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-[13px] tracking-tight text-foreground/50">{client.platform} Â· {client.handle}</p>
                </div>
                <div className="flex flex-col items-end gap-2 shrink-0">
                  ...
                  >{client.status}</span>
                  <a href={client.link} target="_blank" rel="noopener noreferrer" className="rounded-full border border-border bg-card/80 px-4 py-1.5 text-[11px] tracking-tight text-foreground/60 hover:bg-card transition">View page â†—</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <main className="mx-auto max-w-[1100px] px-6 pt-10 sm:px-10">
        ...
        <div className="mb-10">
          ...
          <p className="mt-5 text-[14px] leading-relaxed tracking-tight text-foreground/55 max-w-lg">
            Every client is different â€” different audience, different voice, different goal. Click a client to see how I worked with them.
          </p>
        </div>
        ...
        {/* Client grid â€” macOS desktop icons */}
        <div className="rounded-[16px] border border-border bg-card overflow-hidden mac-shadow">
          ...
          <div className="flex h-9 items-center justify-between border-b border-border bg-secondary/60 px-4">
            ...
            <span className="text-[11px] tracking-tight text-foreground/50">Finder â€” clients</span>
          ...
          <div className="p-10 grid grid-cols-2 sm:grid-cols-4 gap-8">
            {CLIENTS.map((client) => (
              ...
              >
                ...
                {/* Label â€” selected style on hover */}
                <div
          ...
          <div className="border-t border-border px-5 py-2 flex items-center justify-between bg-secondary/30">
            <p className="text-[10px] tracking-tight text-foreground/35">{CLIENTS.length} items Â· click to open</p>
            <div className="flex items-center gap-1.5">
