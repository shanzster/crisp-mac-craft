...
import { H as rootRouteId, e as createRawStreamRPCPlugin, t as invariant, x as isNotFound, y as isRedirect, G as resolveManifestAssetLink, r as getStylesheetHref, f as createSerializationAdapter, o as getNormalizedURL, p as getOrigin, b as attachRouterServerSsrUtils, z as isResolvedRedirect, D as mergeHeaders, l as executeRewriteInput } from "./tanstack__router-core.mjs";
import { a as FrameType, F as FRAME_HEADER_SIZE, h as getDefaultSerovalPlugins, d as X_TSS_SERIALIZED, T as TSS_CONTENT_TYPE_FRAMED_VERSIONED, b as TSS_FORMDATA_CONTEXT, s as safeObjectMerge, X as X_TSS_RAW_RESPONSE, c as TSS_SERVER_FUNCTION, e as createCsrfMiddleware, g as flattenMiddlewares, f as createNullProtoObject } from "./@tanstack/start-client-core.mjs";
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./@tanstack/start-client-core.mjs").then(function(n) {
      return n.i;
    }),
    import("./@tanstack/start-client-core.mjs").then(function(n) {
      return n.j;
