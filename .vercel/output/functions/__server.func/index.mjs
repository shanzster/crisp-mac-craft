...
import { r as renderErrorPage } from "./_libs/@tanstack/start-client-core.mjs";
import { t as toEventHandler, b as toMiddleware, c as callMiddleware, d as defineLazyEventHandler, a as HTTPError, H as H3Core } from "./_libs/h3.mjs";
...
async function getServerEntry() {
  if (!serverEntryPromise) {
    serverEntryPromise = import("./_libs/tanstack__react-start.mjs").then(
      (m) => m.default ?? m
    );
  }
...
const _lazy_0jlx2W = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
const findRoute = /* @__PURE__ */ (() => {
  const $0 = { route: "/**", handler: multiHandler(toEventHandler(_6TlLRF), _lazy_0jlx2W) };
  return (m, p) => {
    if (p.charCodeAt(p.length - 1) === 47) p = p.slice(0, -1) || "/";
    let s = p.split("/");
    s.length;
